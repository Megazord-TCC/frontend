...
import { PortfolioEventDetailParticipantsTabComponent } from './portfolio-event-detail-participants-tab/portfolio-event-detail-participants-tab.component';
...
@Component({
    ...
    imports: [
        ...
        PortfolioEventDetailParticipantsTabComponent
    ],
